...
rm(models_1977_2_0L_intercept_100)
rm(models_1977_2_0L_time_100)
rm(models_1977_2_1L_intercept_100)
rm(models_1977_2_1L_time_100)
```

### Etas (coefficients within segments)

```{r etas, fig.height = 50, fig.width = 12, eval = T}
...
```{r rhos, fig.width = 12, fig.height= 20}
