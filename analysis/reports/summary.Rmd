...
```{r etas 10k, fig.width = 20, fig.height = 20}
...
```{r etas 100k, fig.width = 40, fig.height = 20}
...
```{r rhos 1000, fig.width = 20, fig.height = 15}
...
```{r rhos 100000, fig.width = 20, fig.height = 15}
