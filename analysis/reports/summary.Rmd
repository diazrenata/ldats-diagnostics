...
```{r etas 100, fig.width = 10, fig.height = 60}
...
```{r etas 1k, fig.width = 20, fig.height = 60}
...
```{r etas 100k, fig.width = 40, fig.height = 60}
...
```{r rhos 100, fig.width = 10, fig.height = 60}
...
```{r rhos 1000, fig.width = 20, fig.height = 60}
...
```{r rhos 10000, fig.width = 20, fig.height = 60}
